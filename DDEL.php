...
error_reporting(1);
$todel=$_GET['rno'];
mysqli_query($link,"update doct SET dshow='N' where AAdharid='$todel' ;");
$rs1=mysqli_query($link,"SELECT * from doct where dshow='Y' order by
dname;");
?>

<h2>Records Deleted</h2>
...
Records</font></td></tr>
<tr><td><table width=750 cellspacing=0 cellpadding=5>
<tr bgcolor=#ccccc><td align=center>AAdhar id</td><td align=center>Doctor
Name</td><td align=center>Specialization</td><td
align=center>Options</td></tr>
<?php
$rs2=mysqli_query($link,"SELECT * from doct where dshow='N' order by
dname;");
$sno=1;
